      ...
      <SimpleGrid display={{base:"none", md:"grid"}} columns={{md:4,lg:5,xl:6}} spacing="20px" className='sortBox' p={{base:"10px", md:"20px"}}>
        ...
        <Menu>
          ...
          <MenuOptionGroup onChange={(e)=>e=="all"?setSearch(""):setSearch(e)}>
            ...
            <MenuItemOption value="Cotton%20T-shirt" >Cotton T-shirt(101)</MenuItemOption>
            <MenuItemOption value="Casual%20Shirt">Casual Shirt(74)</MenuItemOption>  
            <MenuItemOption value="Formal%20Blazer">Formal Blazer(6)</MenuItemOption> 
            <MenuItemOption value="Casual%20Blazer">Casual Blazer(3)</MenuItemOption> 
            <MenuItemOption value="Kurta">Kurta(12)</MenuItemOption>
            <MenuItemOption value="Printed%20T-shirt" >Printed T-shirt(23)</MenuItemOption>        
            <MenuItemOption value="Sweatshirt" >Sweatshirt(3)</MenuItemOption>    
            <MenuItemOption value="Striped" >Striped Shirt & T-shirt(25)</MenuItemOption>
            <MenuItemOption value="Collar%20T-shirt" >Collar T-shirt(50)</MenuItemOption>
            <MenuItemOption value="Round%20Neck" >Round Neck(19)</MenuItemOption>    
            <MenuItemOption value="Oversized" >Oversized T-shirt(10)</MenuItemOption>      
          </MenuOptionGroup>
          </MenuList>
        </Menu>
        <Menu>
          ...
          <RangeSlider
            ...
            onChangeEnd={(val) =>{debounce(val,2500); setMin(val[0]*7); setMax(val[1]*7)}}
          >
            <RangeSliderTrack>
        ...
        <Menu>
          ...
          <MenuOptionGroup onChange={(e)=>dispatch(getBrandFun(e))}>
            ...
            <MenuItemOption value="HRX">HRX by Hrithik Roshan(41)</MenuItemOption>
            ...
            <MenuItemOption value="Louis">Louis Philippe Sport(25)</MenuItemOption>
            ...
            <MenuItemOption value="Harbour">Mast & Harbour(10)</MenuItemOption>
        ...
        <Menu>
          ...
          <MenuOptionGroup onChange={(e)=>e=="all"?setSearch(""):setSearch(e)}>
            ...
            <MenuItemOption value="Embroidered" >Embroidered(3)</MenuItemOption>
            <MenuItemOption value="Sustainable" >Sustainable(5)</MenuItemOption>
          </MenuOptionGroup>
          </MenuList>
        </Menu>
      </SimpleGrid>
      <SimpleGrid display={{base:"flex", md:"none"}} columns={{md:4,lg:5,xl:6}} spacing="20px" className='sortBox' p={{base:"10px", md:"20px"}}>
        <Menu closeOnSelect={false}>
          <MenuButton transition='all 0.2s' w="100%" p="10px 20px">
            <Flex justifyContent="space-between">
              <Text>Sort</Text>
              <Text fontSize="20px"><ChevronDownIcon /></Text>
            </Flex>
          </MenuButton>
          <MenuList borderRadius='none'>
          <MenuOptionGroup onChange={(e)=>dispatch(sortFun(e))}>
